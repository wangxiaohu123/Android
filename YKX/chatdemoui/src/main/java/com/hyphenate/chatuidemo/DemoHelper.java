...
public class DemoHelper {
    ...
    public static Class<? extends Activity> exceptionActivity=MainActivity.class;
    ...
    protected void onUserException(String exception){
        ...
        if (exceptionActivity!=null) {
            Intent intent = new Intent(appContext, exceptionActivity);
    ...
    protected void oldOnUserException(String exception){
        EMLog.e(TAG, "onUserException: " + exception);
