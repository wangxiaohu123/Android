package com.ykx.baselibs.views.refreshview.pulltorefreshswipemenulistviewsample;
...
import com.ykx.baselibs.views.refreshview.pulltorefresh.PullToRefreshListFooter;
import com.ykx.baselibs.views.refreshview.pulltorefresh.PullToRefreshListHeader;
import com.ykx.baselibs.views.refreshview.pulltorefresh.RefreshTime;
import com.ykx.baselibs.views.swipemenulistview.SwipeMenu;
import com.ykx.baselibs.views.swipemenulistview.SwipeMenuAdapter;
import com.ykx.baselibs.views.swipemenulistview.SwipeMenuCreator;
import com.ykx.baselibs.views.swipemenulistview.SwipeMenuLayout;
import com.ykx.baselibs.views.swipemenulistview.SwipeMenuView;
...
public class PullToRefreshSwipeMenuListView extends ListView implements OnScrollListener {
    ...
    // add OnScrollStateChangedListener
        ...
        case MotionEvent.ACTION_MOVE:
            ...
            if ((mTouchView == null || !mTouchView.isActive()) && Math.pow(dx, 2) / Math.pow(dy, 2) <= 3) {
                if (getFirstVisiblePosition() == 0 && (mHeaderView.getVisiableHeight() > 0 || deltaY > 0)) {
                    ...
                    if ((!mEnablePullLoad)&&(mFooterView.getBottomMargin()>=0)){
                    }else {
    ...
    public void stopRefresh() {
        ...
        RefreshTime.setRefreshTime(getContext(), DateUtil.format(new Date(), DateUtil.DATE_FORMAT));
    }
    ...
    public void setRefreshTime(String time) {
        if ((time!=null)&&(time.length()>0)) {
            ...
            time= DateUtil.format(new Date(), DateUtil.DATE_FORMAT);
        }
    ...
    public void onScrollStateChanged(AbsListView view, int scrollState) {
        ...
        if (onScrollStateChangedListener != null){
            onScrollStateChangedListener.onScrollStateChg(scrollState);
        }
    }

    public interface OnScrollStateChangedListener{
        void onScrollStateChg(int scrollState);
    }
