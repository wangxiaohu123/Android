package com.ykx.baselibs.views.refreshview.pulltorefresh;
...
//        mGifImageView = (GifImageView) findViewById(R.id.xlistview_logo_arrow);
//        //gif 代码控制播放速度
//        try {
//            GifDrawable gifDrawable = new GifDrawable(getResources(), R.drawable.refresh_log);
