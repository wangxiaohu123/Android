...
public class WheelTime {
    ...
    public WheelTime(View view, Type type, int gravity, int textSize,int dur) {
        super();
        this.dur=dur;
        this.view = view;
        this.type = type;
...
// 判断大小月及是否闰年,用来确定"日"的数据
      ...
      /*  wv_hours.setLabel(context.getString(R.string.pickerview_hours));// 添加文字*/
       ...
       /* wv_seconds.setLabel(context.getString(R.string.pickerview_seconds));// 添加文字*/
        ...
        wv_year.resetDurWidth(dur);
        wv_month.resetDurWidth(dur);
        wv_day.resetDurWidth(dur);
        wv_hours.resetDurWidth(dur);
        wv_mins.resetDurWidth(dur);
        wv_seconds.resetDurWidth(dur);

        wv_day.setDrawFlag(false);
        wv_seconds.setDrawFlag(false);
    }
