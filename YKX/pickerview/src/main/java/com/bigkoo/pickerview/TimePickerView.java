...
public class TimePickerView extends BasePickerView implements View.OnClickListener {
    ...
    //构造方法
    public TimePickerView(Builder builder,int dur) {
    ...
    public static class Builder {
        ...
        private int dur=0;
        public void resetDurWidth(int dur){
            this.dur=dur;
        }
        ...
        public TimePickerView build(int dur) {
            return new TimePickerView(this,dur);
        }
    }


    private void initView(Context context,int dur) {
...
//            rv_top_bar.setBackgroundColor(Color_Background_Title == 0 ? pickerview_bg_topbar : Color_Background_Title);
        ...
        wheelTime = new WheelTime(timePickerView, type, gravity, Size_Content,dur);
